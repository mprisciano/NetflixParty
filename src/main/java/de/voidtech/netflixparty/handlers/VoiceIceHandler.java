...
@Handler
public class VoiceIceHandler extends AbstractHandler {
    ...
    public void execute(WebSocketSession session, JSONObject data) {
        ...
        if (partyService.getParty(roomID) == null)
            ...
            responder.sendSystemMessage(party, new MessageBuilder()
                    ...
                    .data(new JSONObject().put("candidate", candidate).put("user", user))
                    .buildToSystemMessage());
        }
    }

    @Override
    public String getHandlerType() { return "voice-ice"; }
