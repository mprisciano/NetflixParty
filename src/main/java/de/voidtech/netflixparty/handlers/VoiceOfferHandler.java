...
@Handler
public class VoiceOfferHandler extends AbstractHandler {
    ...
    public void execute(WebSocketSession session, JSONObject data) {
        ...
        if (partyService.getParty(roomID) == null)
            ...
            responder.sendSystemMessage(party, new MessageBuilder()
                    ...
                    .data(new JSONObject().put("offer", offer).put("user", user))
                    .buildToSystemMessage());
        }
    }

    @Override
    public String getHandlerType() { return "voice-offer"; }

    @Override
    public boolean requiresRateLimit() { return true; }
}