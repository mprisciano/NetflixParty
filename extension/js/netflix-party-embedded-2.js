console.log("Netflix embedded loaded");
"use strict";
...
function injectPage() {
    ...
    let videoDiv = document.querySelector("#appMountPoint > div > div > div > div > div > div");
    ...
    userButton.onmouseover = () => userButton.style.backgroundColor = "#b20710";
    userButton.onmouseout = () => userButton.style.backgroundColor = "#e50914";
    ...
    chatHistory.appendChild(userButton);
    ...
    <div style="display: flex; align-items: center; gap: 8px;">
        <button id="call-button" style="
            ...
            transition: background-color 0.2s ease;
        ">📞 Call</button>
        <input type="text" id="chat-input" placeholder="Enter a message" autocomplete="off" style="flex: 1;">
    </div>
